...
CreateDocWindow::CreateDocWindow(const ScrollableScreenBufferBuilder& ssbBuilder) :
    BaseWindow(ssbBuilder) {}

Event CreateDocWindow::processChar(TCPClient& client, const KeyPack& key, const std::string& clipboardData) {
    ...
    case BACKSPACE:
        ...
        return Event{};
    case ENTER:
        return Event{ windows::app::events::createDoc, className, windows::app::name, { doc.getText() } };
    case ARROW_LEFT:
